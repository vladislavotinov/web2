...
<br><select size="1" name="breed">'.str_replace('>'.$_SESSION['USER_BREED'], 'selected>'.$_SESSION['USER_BREED'], '<option value="0">Не скажу</option><option value="1">Белая</option><option value="2">Темненькая</option><option value="3">Лысик</option><option value="4">Тигровая</option>').'</select>
